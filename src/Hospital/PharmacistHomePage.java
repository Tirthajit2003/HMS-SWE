 ...
 */
public class PharmacistHomePage extends JFrame implements ActionListener {
    JLabel l1;
    Font f, f1, f2;
    String name;
    PharmacistHomePage(String adminName) {
...
//        JMenuItem ment14 = new JMenuItem("View Laboratorists");
        ...
        JMenu men8 = new JMenu("Hi, Pharmacist(" + adminName + ")");
...
//        men7.add(ment14);
        ...
        JMenuItem[] allMenuItems = {ment2,viewPrescriptionMenuItem, ment12, ment15, ment16, ment17};
...
//                break;
    ...
    public static void main(String[] args) {
        new PharmacistHomePage("Pharmacist").setVisible(true);
    }
}
